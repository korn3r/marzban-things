...
#### ru-node / sub_templates / index.html
Модифицированный шаблон (оригинал вроде бы - https://github.com/x0sina/marzban-sub)
Оставлены только клиенты happ, v2rayng, v2rayn, streisand, v2raytun (потому что поддерживают xHTTP). Убран фон. На Windows по-умолчанию предлагает Happ for desktop
